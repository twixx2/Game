...
export const SapperPage = () => {
    ...
    const { bet, phase, game, isPlay, mineOptions, minesCount, coeffs, seed, provablyFairData, createGame, openCell, blindShot, setMinesCount, typeBet, rollNewSeed, setSeed } = useHelperSapper();
