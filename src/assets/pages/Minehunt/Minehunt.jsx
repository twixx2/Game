...
const Minehunt = () => {
    ...
    const [cellCount, setCellCount] = useState(22);
    const coinsOptions = [22]
    const coeffsMap = {
        22: [7.91, 94.92, 2_183.16]
    };
    const coeffs = coeffsMap[cellCount];
    const STORAGE_KEY = "minehunt-game-state";
                            ...
                            <div className="sapper_options">
                                ...
                                <div className="mines_options">
                                    {coinsOptions.map(n => (
                                        <button
                                            key={n}
                                            className={n === cellCount ? "opt opt--active" : "opt"}
                                        >
                                            {n}
                                        </button>
                                    ))}
