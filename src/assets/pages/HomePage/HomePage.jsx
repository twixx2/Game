        ...
        <div className="home">
            ...
            <main className="home_main">
                ...
                <p className="disclaimer_text">
                    Настоящий проект
                    представляет собой исключительно развлекательную платформу и не является формой азартной игры или казино.
                    Все внутриигровые валюты, ставки, элементы игрового процесса и баланс являются полностью вымышленными и не обладают денежной стоимостью,
                    не подлежат пополнению или конвертации в реальные средства.
                    Автор проекта категорически осуждает любые незаконные действия, связанные с азартными играми, и не осуществляет призыв к участию в таковой деятельности.
                </p>
